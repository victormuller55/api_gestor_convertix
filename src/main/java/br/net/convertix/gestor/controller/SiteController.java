...
public class SiteController {
    ...
    @Operation(summary = "Listar sites ou buscar por filtros")
    @GetMapping
    public ResponseEntity<List<SiteResponse>> buscar(
        ...
        return ResponseEntity.ok(siteService.buscar(id, query));
    }
